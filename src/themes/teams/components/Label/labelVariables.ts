...
import { ColorValues, ColorScheme, SiteVariablesPrepared, PxToRemFunc } from '../../../types'
...
export default (siteVars: SiteVariablesPrepared, pxToRem: PxToRemFunc): LabelVariables => {
