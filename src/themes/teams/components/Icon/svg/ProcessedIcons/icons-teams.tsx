...
export default {
  icon: ({ classes }) => (
    <svg role="presentation" focusable="false" viewBox="8 8 16 16" className={classes.svg}>
      ...
      />
      <circle className={classes.filledPart} cx="10" cy="13" r="2" />
      <circle className={classes.filledPart} cx="16" cy="12" r="2" />
      <circle className={classes.filledPart} cx="22" cy="13" r="2" />
    </svg>
  ),
  styles: {},
} as TeamsSvgIconSpec
