...
export default {
  icon: ({ classes }) => (
    <svg role="presentation" focusable="false" viewBox="8 8 16 16" className={classes.svg}>
      ...
      />
      <circle className={classes.outlinePart} cx="9" cy="12.5" r="1" />
      <circle className={classes.outlinePart} cx="12.5" cy="17.5" r="1" />
      <circle className={classes.outlinePart} cx="12.5" cy="22.5" r="1" />
      <circle className={classes.filledPart} cx="9" cy="12.5" r="1" />
      <circle className={classes.filledPart} cx="12.5" cy="17.5" r="1" />
      <circle className={classes.filledPart} cx="12.5" cy="22.5" r="1" />
    </svg>
  ),
  styles: {},
