...
- Change `createShorthandFactory` API, added `as` prop functionality in order to deprecate HTML factories @Bugaa92 ([#376](https://github.com/stardust-ui/react/pull/376))
