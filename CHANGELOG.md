...
- Add Header `color`, `background`, `subheaderBackground` and `subheaderColor` props @mnajdova
- Add Header.Subheader `color` and `background` props @mnajdova ([#110](https://github.com/stardust-ui/react/pull/110))
