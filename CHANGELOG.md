...
- Add `disabled` prop and `colorDisabled`, `backgroundColorDisabled`, `borderColorDisabled`, `borderStyle`, `borderWidth` variables for `Segment` component @Bugaa92 ([#1516](https://github.com/stardust-ui/react/pull/1516))
