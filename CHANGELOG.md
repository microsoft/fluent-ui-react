...
- Export `message-seen`, `presence-available`, `presence-stroke` and `open-outside`  icons to Teams theme @joheredi ([#1390](https://github.com/stardust-ui/react/pull/1390))
