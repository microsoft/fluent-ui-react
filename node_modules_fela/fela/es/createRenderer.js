...
import * as perf from '../../../packages/react/src/lib/perf'
...
export default function createRenderer() {
  ...
  var renderer = {
    ...
    renderRule: perf.time('[fela] renderRule', function renderRule(rule) {
      var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}

      return renderer._renderStyle(rule(props, renderer), props)
    }),
    renderKeyframe: perf.time('[fela] renderKeyframe', function renderKeyframe(keyframe) {
      var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}
      ...
      if (!renderer.cache.hasOwnProperty(keyframeReference)) {
        ...
        var processedKeyframe = processStyleWithPlugins(
          renderer,
          resolvedKeyframe,
          KEYFRAME_TYPE,
          props,
        ...
        var cssKeyframe = cssifyKeyframe(
          processedKeyframe,
          animationName,
    ...
    renderFont: perf.time('[fela] renderFont', function renderFont(family, files) {
    ...
    renderStatic: perf.time('[fela] renderStatic', function renderStatic(staticStyle, selector) {
    ...
    _renderStyle: perf.time('[fela] _renderStyle', function _renderStyle() {
    ...
    _renderStyleToClassNames: perf.time('[fela] _renderStyleToClassNames', function _renderStyleToClassNames(_ref) {
    ...
    _emitChange: perf.time('[fela] _emitChange', function _emitChange(change) {
