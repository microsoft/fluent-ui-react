...
import { prefix as p } from 'inline-style-prefixer'
import c from 'css-in-js-utils/lib/cssifyObject'
import objectReduce from 'fast-loops/lib/objectReduce'

import fallbackValue from 'fela-plugin-fallback-value'
import isPlainObject from 'isobject'

const prefix = perf.time('[fela-plugin]: vendor | inline-style-prefixer', p)
const cssifyObject = perf.time('[fela-plugin]: vendor | cssifyObject', c)

var resolveFallbackValues = fallbackValue()

const a = perf.time('[fela-plugin]: vendor', function addVendorPrefixes(style) {
  return objectReduce(
    style,
    function(prefixedStyle, value, property) {
