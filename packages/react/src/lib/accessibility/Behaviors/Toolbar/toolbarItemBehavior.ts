 ...
 * Adds attribute 'aria-haspopup=menu' to 'root' component's part if 'menu' property is set.
 * Adds attribute 'aria-haspopup=dialog' to 'root' component's part if 'menu' property is set.
