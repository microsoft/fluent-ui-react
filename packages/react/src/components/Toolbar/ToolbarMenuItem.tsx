...
> {
  ...
  static getDerivedStateFromProps = AutoControlledComponent.getDerivedStateFromProps
  static getAutoControlledStateFromProps = AutoControlledComponent.getAutoControlledStateFromProps
