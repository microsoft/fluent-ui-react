...
const updatedMenuItemStyles: ComponentSelectorsAndStyles<MenuItemProps, MenuVariables> = v => {
  return {
    wrapper: [
      [
        null,
      ...
      [{ pills: true, vertical: true }, { margin: `0 0 ${verticalPillsBottomMargin} 0` }],
      [{ pills: true, vertical: false }, { margin: `0 ${horizontalPillsRightMargin} 0 0` }],
      [
        { underlined: true },
        {
          display: 'flex',
...
export default backportComponentStyle(updatedMenuItemStyles)
