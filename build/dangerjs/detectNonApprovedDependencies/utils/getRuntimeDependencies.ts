...
/**
 * It is necessary to cotrresppondign Gulp task in a separate process.
 * This task relies on webpack's crawling through the imported modules,
 * but when this is run from DangerJS process, there is no crawling happening.
