...
Our components implement `render props` technique to allow customize rendered output or wrap component slots. All Stardust components support it via `children` prop on shorthand objects, for example:
