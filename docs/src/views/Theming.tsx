...
export default () => (
  <DocPage title="Theming">
    ...
    <ol>
      ...
      <li>
        <strong>Pixel Perfect</strong> - Users who with pixel perfect design requirements.
      </li>
    </ol>
    ...
    <p>
      ...
      Example, the <code>Button</code> anatomy of a defines an <code>icon</code> part.
    </p>

    <p>
      Styles are applied to components according to{' '}
      <NavLink to="component-anatomy">Component Anatomy</NavLink>. You would style the{' '}
      <code>icon</code> part of a <code>Button</code> component.
    </p>
    ...
    <ExampleSnippet label="js" value={`const style = { color: 'green' }`} />
    <Text styles={{ root: { color: 'green' } }}>This is green text</Text>

    <Header as="h2" content="None" />
    ...
    <Header as="h2" content="Opt-in" />
    <p>Opt-in</p>

    <Header as="h2" content="Pixel Perfect" />
    <p>Pixel Perfect</p>
