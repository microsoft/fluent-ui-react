...
export default () => (
  <DocPage title="Accessibility in Stardust">
    ...
    <p>
      ...
      toolbar, items in a list). Read more about Focus Zone {link('here', '/focus-zone')}.
    </p>
    ...
    <p>
      ...
      based on the {link('accessibility behaviors', '#_Accessibility_Behaviors')} of the component.
      Users can override these and provide their own roles and attributes by changing the behaviour
      applied.
    </p>
    ...
    <Header as="h2" content="Accessibility Behaviors" />
    <p>
    ...
    <p>
      ...
      there will be additional behaviors to choose from. In addition to that, user can create custom
    ...
    <p>
      ...
      {code('MenuItemBehavior')} for the menu items). These behaviors add appropriate ARIA roles by
      default:
    </p>
    <p>Rendered HTML:</p>
    <CodeSnippet
    ...
    <Segment inverted>
      ...
      <p>
        ...
        provided as a child component, no behaviors are applied on these children. Consider the
        following example:
      </p>
      <CodeSnippet
        value={`
    ...
    <Header as="h4" content="Overriding behaviors" />
    <p>
