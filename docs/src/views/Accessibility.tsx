...
export default () => (
  <DocPage title="Accessibility in Stardust">
    ...
    <p>
      ...
      based on the {link('accessibility behaviors', '/accessibility-behaviors')} of the component.
      Users can override these and provide their own roles and attributes by changing the behavior
      applied.
    </p>
