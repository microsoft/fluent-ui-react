...
import { ListWithReactVirtualized } from '@stardust-ui/react'

const imgStyle = { display: 'block', width: 28, borderRadius: 9999 }

const ListExampleWithReactVirtualized = ({ knobs }) => (
  <ListWithReactVirtualized
    items={[
      {
        key: 'irving',
...
export default ListExampleWithReactVirtualized
